...
describe("Barcode Value Object", () => {
  it("should create valid UPC-A barcodes and validate check digits", () => {
    ...
    expect(() => new Barcode(BarcodeSymbology.UPC_A, "01234567890A")).toThrow(/12 digits/i);
  });
  ...
  it("should create valid EAN-13 barcodes and validate check digits", () => {
    ...
    expect(() => new Barcode(BarcodeSymbology.EAN_13, "400638133393A")).toThrow(/13 digits/i);
  });
  ...
  it("should validate fixed length numeric barcodes", () => {
    ...
    const upce = new Barcode(BarcodeSymbology.UPC_E, "12345678");
    expect(upce.value).toBe("12345678");
    expect(() => new Barcode(BarcodeSymbology.UPC_E, "1234567")).toThrow(/8 digits/i);
  ...
  it("should validate Code 128 barcodes", () => {
    ...
    const gs1 = new Barcode(BarcodeSymbology.GS1_128, "INV-1234-ABCD");
    expect(gs1.value).toBe("INV-1234-ABCD");
  });
